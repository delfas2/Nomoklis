...
urlpatterns = [
    ...
    # path('chat/<int:tenant_id>/', views.chat_room_view, name='chat_room'),
    ...
    path('landlord/problems/<int:problem_id>/', views.landlord_problem_detail_view, name='landlord_problem_detail'),
    path('problems/<int:problem_id>/', views.tenant_problem_detail_view, name='tenant_problem_detail'),
